...
//go:generate swagger generate server --target .. --name  --spec ../auction-swagger.yaml
...
func configureAPI(api *operations.AuctionAPI) http.Handler {
	...
	api.AuctionByAuctionIDHandler = operations.AuctionByAuctionIDHandlerFunc(func(params operations.AuctionByAuctionIDParams) middleware.Responder {
